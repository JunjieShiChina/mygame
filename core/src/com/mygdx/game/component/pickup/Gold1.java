...
public class Gold1 extends Gold {

    private static Sound genCoinSound = Gdx.audio.newSound(Gdx.files.internal("coinsplash.ogg"));

    private static Texture texture = new Texture("gold1.png");

    public Gold1(World world, float positionX, float positionY, float xSpeed, float ySpeed) {
