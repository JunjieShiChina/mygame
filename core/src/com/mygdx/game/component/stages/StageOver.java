...
public class StageOver implements Stage{
    ...
    private void renderThanks(SpriteBatch batch) {
        ...
        if (startTimer > startBlinkTime) {
            ...
            int spaceSize = 0;
            // T
            TextureRegion textureRegion = FontTextureUtils.getDigitsTexture()[2][9];
            ...
            // K
            textureRegion = FontTextureUtils.getDigitsTexture()[2][0];
            sprite = new Sprite(textureRegion);
            sprite.setSize(fontWidth, fontHeight);
            ...
            sprite = new Sprite(textureRegion);
            sprite.setSize(fontWidth, fontHeight);
            sprite.setPosition(startX + fontWidth * 5 - spaceSize * 5, height);
            sprite.draw(batch);


            // F
            textureRegion = FontTextureUtils.getDigitsTexture()[1][5];
            sprite = new Sprite(textureRegion);
            sprite.setSize(fontWidth, fontHeight);
            ...
            sprite = new Sprite(textureRegion);
            sprite.setSize(fontWidth, fontHeight);
            sprite.setPosition(startX + fontWidth * 11 - spaceSize * 11, height);
            sprite.draw(batch);

            // L
            textureRegion = FontTextureUtils.getDigitsTexture()[2][1];
            sprite = new Sprite(textureRegion);
            sprite.setSize(fontWidth, fontHeight);
            sprite.setPosition(startX + fontWidth * 12 - spaceSize * 12, height);
            sprite.draw(batch);
            ...
            sprite = new Sprite(textureRegion);
            sprite.setSize(fontWidth, fontHeight);
            sprite.setPosition(startX + fontWidth * 13 - spaceSize * 13, height);
            sprite.draw(batch);

            // Y
            textureRegion = FontTextureUtils.getDigitsTexture()[3][4];
            sprite = new Sprite(textureRegion);
            sprite.setSize(fontWidth, fontHeight);
            sprite.setPosition(startX + fontWidth * 14 - spaceSize * 14, height);
            sprite.draw(batch);
        }
