...
public class Bullet6 extends Bullet {
    ...
    private static Texture texture = new Texture("bullet6.png");
    private static Sound shootSound = Gdx.audio.newSound(Gdx.files.internal("biu.wav"));

    public Bullet6(World world, float rotation, float bulletAngle, Shooter shooter) {
        super(world, texture, rotation, shooter, 3, 0.5f, 0.5f, 10, bulletAngle);
    }
